...
if (process.argv.length < 8){console.log(`invalid usage!\nnode rapid bypass [time] [threads] [proxyfile] [rate] [target]\nDeveloper @Mrcyberteam project rapid methods`); process.exit();}
const headers = {};
