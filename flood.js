...
const RATE_LIMIT_THRESHOLD = 3; // S? l?n rate limit tru?c khi dánh d?u proxy
const SESSION_ROTATE_REQUESTS = 35; // S? request tru?c khi rotate session
const PROXY_COOLDOWN = 45000; // Th?i gian cooldown cho proxy (ms)
const REQUEST_DELAY_MIN = 25; // Min delay gi?a các request (ms) 
const REQUEST_DELAY_MAX = 85; // Max delay gi?a các request (ms)
